...
function App() {
 const[color,setColor] = useState("olive");
  ...
  <div className="flex flex-wrap justify-center gap-3 shadow-lg bg-white px-3 py-2 rounded-3xl">
   ...
   <button onClick={()=>{setColor("white")}} className="outline-none px-4 py-1 rounded-full text-black shadow-sm" style={{backgroundColor:"white", border:"1px solid black"}}>White</button>
